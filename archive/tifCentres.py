...
def tifCentroids(path='images/1carr-96etoh-alexa-sted-decon.tif', threshold_value=130):
...
def whitePixels(path='images/1carr-96etoh-alexa-sted-decon.tif', threshold_value=130):
    img = Image.open(path).convert('L')
    image = np.array(img)
